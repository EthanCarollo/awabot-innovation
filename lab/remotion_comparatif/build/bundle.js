...
const BarPair = ({
  ...
  const delay = index * 8;
  const makePct = (val) => (val - FLOOR) / (CEIL - FLOOR) * BAR_HEIGHT;
  const frProgress = (0,esm.spring)({
    frame: frame - delay,
    fps,
    config: { damping: 14, stiffness: 50 }
  });
  const enProgress = (0,esm.spring)({
    frame: frame - delay - 4,
    fps,
    config: { damping: 14, stiffness: 50 }
  });
  const zhProgress = (0,esm.spring)({
    frame: frame - delay - 8,
    fps,
    config: { damping: 14, stiffness: 50 }
  });
  ...
  const labelOpacity = (0,esm.interpolate)(frame, [delay + 15, delay + 25], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const renderBar = (val, height, flag, progress) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }, children: [
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              opacity: flag === "\u{1F1E8}\u{1F1F3}" ? 1 : flag === "\u{1F1EC}\u{1F1E7}" ? 0.85 : 0.7
            }
          }
        )
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 32, fontWeight: 600, color: "#64748B" }, children: flag })
  ] });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 16, alignItems: "flex-end", height: BAR_HEIGHT + 100 }, children: [
          renderBar(model.fr, frH, "\u{1F1EB}\u{1F1F7}", frProgress),
          renderBar(model.en, enH, "\u{1F1EC}\u{1F1E7}", enProgress),
          renderBar(model.zh, zhH, "\u{1F1E8}\u{1F1F3}", zhProgress)
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
...
const MyComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      ...
      children: MODELS.map((m, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(BarPair, { model: m, index: i }, m.name))
    }
  );
};
...
const TranslationAnim = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const titleOpacity = (0,esm.interpolate)(frame, [0, 15], [0, 1], {
    extrapolateRight: "clamp"
  });
  const frProgress = (0,esm.spring)({
    frame: frame - 15,
  ...
  const enProgress = (0,esm.spring)({
    frame: frame - 40,
    // Translates after a brief pause
    fps,
    config: { damping: 14, stiffness: 60 }
  });
  const frY = (0,esm.interpolate)(frProgress, [0, 1], [30, 0]);
  const frOpacity = frProgress;
  const enY = (0,esm.interpolate)(enProgress, [0, 1], [-30, 0]);
  const enOpacity = enProgress;
  const arrowProgress = (0,esm.spring)({
    frame: frame - 30,
    // Arrow appears between FR and EN
    fps,
    config: { damping: 14, stiffness: 60 }
  });
  const arrowOpacity = arrowProgress;
  const arrowScale = (0,esm.interpolate)(arrowProgress, [0, 1], [0.8, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    ...
                    // Using a green accent for LibreTranslate 
                    borderRadius: 8,
                    display: "flex",
                    justifyContent: "center",
                    alignItems: "center",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 60 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              style: {
              ...
              children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 24, fontWeight: 700, color: "#94A3B8" }, children: "FR \u{1F1EB}\u{1F1F7}" }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
                      ...
                      borderLeft: "8px solid #FF7E22",
                      // Orange
                      minHeight: 120,
                      display: "flex",
                      alignItems: "center"
                    },
                    children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 36, fontWeight: 600, color: "#334155", lineHeight: 1.4 }, children: "Bonjour, comment allez-vous ?" })
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 24, fontWeight: 700, color: "#94A3B8", textAlign: "right" }, children: "\u{1F1EC}\u{1F1E7} EN" }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
                      ...
                      borderRadius: 24,
                      boxShadow: "0 20px 40px rgba(0,0,0,0.05)",
                      borderRight: "8px solid #FAC130",
                      // Yellow
                      minHeight: 120,
                      display: "flex",
                      alignItems: "center"
                    },
                    children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 36, fontWeight: 600, color: "#334155", lineHeight: 1.4 }, children: "Hello, how are you?" })
                  }
                )
              ]
            }
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(283), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 5283)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "remotion_comparatif:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkremotion_comparatif"] = self["webpackChunkremotion_comparatif"] || [];
