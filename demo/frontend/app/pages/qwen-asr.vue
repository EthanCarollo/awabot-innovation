...
const { status, isRecording, transcript, audioLevel, start, stop, clearTranscript } =
  useAudioCapture(`${config.public.wsBackendBase}/ws/qwen-asr`)
</script>
...
.btn-start { background: linear-gradient(135deg, #818cf8, #6366f1); color: #fff; box-shadow: 0 4px 20px rgba(99,102,241,.3); }
